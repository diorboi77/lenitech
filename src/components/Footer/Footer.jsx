  ...
  <footer>
    <div className="container">
      ...
      <div className="f-left">
            <p className='rr'>User Contact</p>
            <h3>Contact Us for those interested.</h3>
      ...
      <div className="fmain">
        ...
        <div className="card3">
            ...
            <p>STORE - worldwide fashion store since 1978. <br /> We sell over 1000+ branded products on <br /> our web-site.</p>
            <img src="./k7" alt="" />
            <h5><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-globe" viewBox="0 0 16 16">
